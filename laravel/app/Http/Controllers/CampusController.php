...
class CampusController extends BaseController
{
     ...
     * @apiHeader {String} X-Authorization The application's unique access-key.
     * @apiGroup Campus
     * @apiDescription Delete a campus record. This also deletes any room records that are in that campus.
     *
     * @apiParam {Integer} id The numeric API id of the campus.
     * @apiSuccess {Boolean} success Tells the application if the request was successful.
     ...
     * @apiExample {ruby} Ruby
     *      # This code snippet uses an open-source library. http://unirest.io/ruby
     *      response = Unirest.delete "https://databridge.sage.edu/v1/campus",
     *      headers:{ "X-Authorization" => "<Your-API-Key>", "Accept" => "application/json" },
     ...
     * @apiExample {java} Java
     *      # This code snippet uses an open-source library. http://unirest.io/java
     *      HttpResponse <String> response = Unirest.delete("https://databridge.sage.edu/v1/campus")
     *      .header("X-Authorization", "<Your-API-Key>")
     *      .header("Accept", "application/json")
     *      .body("{\"id\":1}")
     *      .asString();
     ...
     * @apiExample {.net} .NET
     *      // This code snippet uses an open-source library http://unirest.io/net
     *       Task<HttpResponse<MyClass>> response = Unirest.delete("https://databridge.sage.edu/v1/campus")
     *       .header("X-Authorization", "<Your-API-Key>")
     *       .header("Accept", "application/json")
     *       .field("id", 1)
     *       .asString();
