...
class AccountController extends ApiController
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($data, [
            'identifier' => 'alpha_num|required|max:7|min:6|unique:service_accounts,identifier|unique:accounts,identifier',
            ...
            'username' => 'string|required|min:3|unique:alias_accounts,username|unique:service_accounts,username|unique:accounts,username',
