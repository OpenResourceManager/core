...
/**
 * @api {post} /birthdates/user_identifier POST: Create/Update BirthDate by User Identifier
 * @apiVersion 1.1.1
 * @apiGroup BirthDates
 ...
 * @apiExample {bash} UUD Client
 *      # This example uses the UUD Client: https://gitlab.sage.edu/UniversalUserData/uud-client
 *      uud -o birthdates -m post -p user_id -d "user_identifier=04986732&birth_date=1992-01-05"
 *
 * @apiExample {bash} Curl
 *      curl -H "X-Authorization: <Your-API-Key>" \
 *      -X "POST" \
 ...
 *      --data "birth_date=1992-01-05" \
 *      --url https://databridge.sage.edu/api/v1/birthdates/user_identifier
 *
 * @apiUse CreateSuccessResultExample
 * @apiUse UpdateSuccessResultExample
 * @apiUse UnprocessableEntityErrors
 * @apiParam (BirthDate Parameters) {String} user_identifier The user's unique identifier string.
 * @apiParam (BirthDate Parameters) {Date} birth_date The user's birth date. In strtotime format: (https://secure.php.net/manual/en/function.strtotime.php).
 */
...
/**
 * @api {delete} /birthdates/user_identifier DELETE: Destroy by User Identifier
 * @apiVersion 1.1.1
 * @apiGroup BirthDates
 ...
 * @apiExample {bash} UUD Client
 *      # This example uses the UUD Client: https://gitlab.sage.edu/UniversalUserData/uud-client
 *      uud -o birthdates -m delete -p user_id -d "user_id=04986732"
 *
 * @apiExample {bash} Curl
 *      curl -H "X-Authorization: <Your-API-Key>" \
 *      -X "DELETE" \
...
/**
 * @api {get} /birthdates/user_identifier/:user_identifier GET: By User Identifier
 * @apiVersion 1.1.1
 * @apiGroup BirthDates
 ...
 * @apiExample {bash} UUD Client
 *      # This example uses the UUD Client: https://gitlab.sage.edu/UniversalUserData/uud-client
 *      uud -o birthdates -p user_id/979659
 *
 * @apiExample {bash} Curl
 *      curl -H "X-Authorization: <Your-API-Key>" --url https://databridge.sage.edu/api/v1/birthdates/user_identifier/979659
 *
 * @apiUse BirthDateSuccess
 * @apiUse GetBirthDateSuccessResultExample
 *
