...
if ($slim->request->headers->get('X-Authorization') && $apiKey = $Controller->checkAPIKey($mysqli, $MySQLiHelper, $slim->request->headers->get('X-Authorization'), Config::getSQLConf()['db_api_key_table'])) {
    ...
    $slim->group(('/department'), function () use ($slim, $Controller, $apiKey, $MySQLiHelper, $sqlConf) {

        $table = $sqlConf['db_department_table'];
        $attrs = Config::getDepartmentAttributes();

        /**
         * @api {post} /department/code/:code Post to Department by code
         * @apiVersion 1.0.0
         * @apiHeader {String} X-Authorization The application's unique access-key.
         * @apiGroup Departments
         * @apiParam {String} Object's unique Datatel code.
         * @apiDescription Using a Datatel code as part of the url parameter, an application can create new department record or update existing records.
         * If the Datatel code in the URL does not exist in the database, the rest of the data sent in the POST request will be treated as a new entry.
         * If the Datatel code in the URL does exist in the database, the data sent in the POST request will replace the data in that record.
         * @apiSuccess {String} application The name of the application that is accessing the API.
         * @apiSuccess {Boolean} success Tells the application if the request was successful.
         ...
         * @apiExample {python} Python
         *      # This code snippet uses an open-source library http://unirest.io/python
         *      response = unirest.post("https://databridge.sage.edu/v1/department/code/:code",
         *          headers={
         *              "X-Authorization": "<Your-API-Key>",
         *              "Accept": "application/json"
         *          },
         ...
         * @apiHeader {String} X-Authorization The application's unique access-key.
         * @apiGroup Departments
         * @apiParam {Int} id Department unique API ID.
         * @apiDescription This method allows an application to view a department record using the database index `ID` number.
         * @apiSuccess {String} application The name of the application that is accessing the API.
         * @apiSuccess {Boolean} success Tells the application if the request was successful.
         * @apiSuccess {Object} result The department record object.
         * @apiSampleRequest https://databridge.sage.edu/v1/department/id/:id
         * @apiExample {curl} Curl
         *      curl -H "X-Authorization: <Your-API-Key>" --url https://databridge.sage.edu/v1/department/id/:id
         * @apiExample {ruby} Ruby
         *      # This code snippet uses an open-source library. http://unirest.io/ruby
         *      response = Unirest.get "https://databridge.sage.edu/v1/department/id/:id",
         *      headers:{ "X-Authorization" => "<Your-API-Key>", "Accept" => "application/json" }.to_json
         * @apiExample {php} PHP
         ...
         *      $headers = New-Object "System.Collections.Generic.Dictionary[[String],[String]]"
         *      $headers.Add("X-Authorization", '<Your-API-Key>')
         *      $result = Invoke-RestMethod -Uri https://databridge.sage.edu/v1/department/id/:id -Headers $headers
         * @apiExample {java} Java
         *      # This code snippet uses an open-source library. http://unirest.io/java
         *      HttpResponse <String> response = Unirest.get("https://databridge.sage.edu/v1/department/id/:id")
         *      .header("X-Authorization", "<Your-API-Key>")
         *      .header("Accept", "application/json")
         *      .asString();
         * @apiExample {python} Python
         ...
         * @apiExample {.net} .NET
         *      // This code snippet uses an open-source library http://unirest.io/net
         *       Task<HttpResponse<MyClass>> response = Unirest.get("https://databridge.sage.edu/v1/department/id/:id")
         *       .header("X-Authorization", "<Your-API-Key>")
         *       .header("Accept", "application/json")
         *       .asString();
         * @apiSuccessExample Success Response:
        ...
        /**
         * @api {get} /department/code/:code Get by Datatel Code
         * @apiVersion 1.0.0
         * @apiHeader {String} X-Authorization The application's unique access-key.
         * @apiGroup Departments
         * @apiParam {String} Datatel code that corresponds with that department.
         * @apiDescription This method allows an application to view a department record using appropriate `Datatel_Code`.
         * @apiSuccess {String} application The name of the application that is accessing the API.
         * @apiSuccess {Boolean} success Tells the application if the request was successful.
         * @apiSuccess {Object} result The department record object.
         * @apiSampleRequest https://databridge.sage.edu/v1/department/code/:code
         * @apiExample {curl} Curl
         *      curl -H "X-Authorization: <Your-API-Key>" --url https://databridge.sage.edu/v1/department/code/:code
         * @apiExample {ruby} Ruby
         *      # This code snippet uses an open-source library. http://unirest.io/ruby
         *      response = Unirest.get "https://databridge.sage.edu/v1/department/code/:code",
         *      headers:{ "X-Authorization" => "<Your-API-Key>", "Accept" => "application/json" }.to_json
         ...
         *      $headers = New-Object "System.Collections.Generic.Dictionary[[String],[String]]"
         *      $headers.Add("X-Authorization", '<Your-API-Key>')
         *      $result = Invoke-RestMethod -Uri https://databridge.sage.edu/v1/department/code/:code -Headers $headers
         * @apiExample {java} Java
         *      # This code snippet uses an open-source library. http://unirest.io/java
         *      HttpResponse <String> response = Unirest.get("https://databridge.sage.edu/v1/department/code/:code")
         *      .header("X-Authorization", "<Your-API-Key>")
         ...
         * @apiExample {.net} .NET
         *      // This code snippet uses an open-source library http://unirest.io/net
         *       Task<HttpResponse<MyClass>> response = Unirest.get("https://databridge.sage.edu/v1/department/code/:code")
         *       .header("X-Authorization", "<Your-API-Key>")
         *       .header("Accept", "application/json")
         *       .asString();
         * @apiSuccessExample Success Response:
        ...
        /**
         * @api {get} /department/:limit Get X Amount of Records
         * @apiVersion 1.0.0
         * @apiHeader {String} X-Authorization The application's unique access-key.
         * @apiGroup Departments
         * @apiParam {Int} limit The max amount of records to return, 0 returns all of them.
         ...
         * @apiSuccess {String} application The name of the application that is accessing the API.
         * @apiSuccess {Boolean} success Tells the application if the request was successful.
         * @apiSuccess {Array} result An array of department record objects.
         * @apiSampleRequest https://databridge.sage.edu/v1/department/:limit
         * @apiExample {curl} Curl
         *      curl -H "X-Authorization: <Your-API-Key>" --url https://databridge.sage.edu/v1/department/:limit
         * @apiExample {ruby} Ruby
         *      # This code snippet uses an open-source library. http://unirest.io/ruby
         *      response = Unirest.get "https://databridge.sage.edu/v1/department/:limit",
         *      headers:{ "X-Authorization" => "<Your-API-Key>", "Accept" => "application/json" }.to_json
         * @apiExample {php} PHP
         ...
         *      $headers = New-Object "System.Collections.Generic.Dictionary[[String],[String]]"
         *      $headers.Add("X-Authorization", '<Your-API-Key>')
         *      $result = Invoke-RestMethod -Uri https://databridge.sage.edu/v1/department/:limit -Headers $headers
         * @apiExample {java} Java
         *      # This code snippet uses an open-source library. http://unirest.io/java
         *      HttpResponse <String> response = Unirest.get("https://databridge.sage.edu/v1/department/:limit")
         *      .header("X-Authorization", "<Your-API-Key>")
         *      .header("Accept", "application/json")
         *      .asString();
         * @apiExample {python} Python
         ...
         * @apiExample {.net} .NET
         *      // This code snippet uses an open-source library http://unirest.io/net
         *       Task<HttpResponse<MyClass>> response = Unirest.get("https://databridge.sage.edu/v1/department/:limit")
         *       .header("X-Authorization", "<Your-API-Key>")
         *       .header("Accept", "application/json")
         *       .asString();
         * @apiSuccessExample Success Response:
        ...
        /**
         * @api {get} /department/ Get Available Methods
         * @apiVersion 1.0.0
         * @apiHeader {String} X-Authorization The application's unique access-key.
         * @apiGroup Departments
         * @apiDescription This method lists the methods available under `/department/`
         * @apiSuccess {String} application The name of the application that is accessing the API.
         * @apiSuccess {Boolean} success Tells the application if the request was successful.
         * @apiSuccess {Object} result The methods that are available
